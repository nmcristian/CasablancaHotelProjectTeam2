...
public class CasablancaGUI extends javax.swing.JFrame
{
    ...
    private String lastAddAction, displayingObjectDetailsType;
    private static CasablancaGUI instance;
    ...
    protected static CasablancaGUI getInstance()
    {
        if (instance == null)
        {
            instance = new CasablancaGUI();
        }
        return instance;
    }
    ...
    private void initComponents()
    {
        ...
        jTextField101.setPreferredSize(new java.awt.Dimension(276, 20));
                        ...
                        .addGroup(jPanelDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelDetailsLayout.createSequentialGroup()
                                .addGroup(jPanelDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel102, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
        ...
        jButtonDelete.setPreferredSize(new java.awt.Dimension(65, 25));
        ...
        jPresentationLayeredPaneLayout.setHorizontalGroup(
            ...
            .addGroup(jPresentationLayeredPaneLayout.createSequentialGroup()
                ...
                .addGroup(jPresentationLayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jLogLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPresentationLayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPresentationLayeredPaneLayout.createSequentialGroup()
                        .addComponent(jButtonAddToReservation, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    protected void addRowAndRefreshTableInfo(Object[] row)
    {
        ((CustomTableModel) jTable1.getModel()).addRow(row);
    ...
    protected void showLog(Color color, String message)
    {
        jLogLabel2.setForeground(color);
        jLogLabel2.setText(message);
    }
...
//            refreshTableInfo();
    ...
    {//GEN-HEADEREND:event_jButtonAddToReservationActionPerformed
        switch (displayingObjectDetailsType)
        {
            case "Rooms":
                controller.addRoomToReservation(Integer.parseInt(jTextField101.getText()));
                jPanelDetails.setVisible(false);
                if (controller.getSearchResultType().equals(displayingObjectDetailsType))
                {
                ...
                jButtonEdit.setEnabled(false);
                jButtonDelete.setEnabled(false);
                reservationForm.refreshReservationTablesInfo(displayingObjectDetailsType);
                break;
            case "Clients":
                controller.addClientToReservation(Long.parseLong(jTextField101.getText()));
                jPanelDetails.setVisible(false);
                if (controller.getSearchResultType().equals(displayingObjectDetailsType))
                {
                    ((CustomTableModel) jTable1.getModel()).removeRow(jTable1.getSelectedRow());
    ...
    private void showDetails(String identifier)
    {
        switch (controller.getSearchResultType())
        {
            case "Rooms":
            {
                ...
                ArrayList<String> temp = controller.getInformationAboutSelectedValueInTable(identifier);
            ...
            case "Reservations":
            {
                jLabel101.setText("Reservation ID");
                jLabel102.setText("Number of clients");
                jLabel103.setText("Number of rooms");
                jLabel104.setText("Confirmation cost");
                jLabel105.setText("Total cost");
                jLabel106.setText("Paid");
                jLabel107.setText("Reservation status");
            ...
            {
                jLabel101.setText("Facility Reservation ID");
                jLabel102.setText("Client ID");
                jLabel103.setText("Client name");
                jLabel104.setText("Facility title");
                jLabel105.setText("Price");
                jLabel106.setText("Duration");
                jLabel107.setText("Starting from");
                ...
                if (controller.getUserType().equals("Manager") || controller.getUserType().equals("Receptionist") || controller.getUserType().equals("Client"))
                {
                    jButtonEdit.setEnabled(true);
                    jButtonDelete.setEnabled(true);
                    jButtonAddToReservation.setEnabled(false);
    ...
    {//GEN-HEADEREND:event_jTable1MouseReleased
        if (evt.getClickCount() == 2)
        {
            if (jTable1.getSelectedRow() != -1)
            {
                ...
                jButtonSaveChanges.setVisible(false);
                jButtonDiscardChanges.setVisible(false);
                showDetails(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
                displayingObjectDetailsType = controller.getSearchResultType();
            }
        } else
        {
            jButtonAddToReservation.setEnabled(false);
    ...
    {//GEN-HEADEREND:event_jComboBox1ActionPerformed
        if (jComboBox1.getSelectedIndex() != -1)
        {
            ...
            if (jComboBox1.getSelectedItem().toString().equals("Add new reservation"))
            {
                ...
                {
                    jLogLabel2.setForeground(Color.red);
                    jLogLabel2.setText("You already have an opened reservation!");
                ...
                } else
                {
                    ...
                    reservationForm.refreshReservationTablesInfo("Rooms");
                    reservationForm.refreshReservationTablesInfo("Clients");
                }
    ...
    {//GEN-HEADEREND:event_jButtonEditActionPerformed
        if (controller.getSearchResultType().equals("Reservations"))
        {
            if (controller.currentReservationCreationState())
            {
                if (reservationForm.getTitle().equals("Casablanca Hotel - New Reservation"))
                {
                    jLogLabel2.setForeground(Color.red);
                    jLogLabel2.setText("You are currently adding a new reservation!");
                } else if (reservationForm.getTitle().equals("Casablanca Hotel - Edit Reservation")
                        && !controller.getNewReservationsID().equals(jTextField101.getText()))
                {
                    jLogLabel2.setForeground(Color.red);
                    jLogLabel2.setText("You are currently editing reservation " + controller.getNewReservationsID() + "!");
                } else
                {
                    showLog(Color.black, "Editing reservation " + controller.getNewReservationsID());
                    reservationForm.requestFocus();
                }
            } else
            {
                ...
                reservationForm = new ReservationForm();
                reservationForm.setLocation((int) (this.getLocation().getX() + this.getSize().getWidth() + 10), (int) (this.getLocation().getY()));
                reservationForm.setTitle("Casablanca Hotel - Edit Reservation");
                reservationForm.setVisible(true);
                reservationForm.requestFocus();
            }
        } else
    ...
    {//GEN-HEADEREND:event_jButtonSaveChangesActionPerformed
        if (lastAddAction != null)
        {
            switch (lastAddAction)
            {
                case "Add new client":
                {
                    ...
                    {
                        jLogLabel2.setForeground(Color.black);
                        jLogLabel2.setText("Saving new client...");
                        ...
                        {
                            jLogLabel2.setForeground(Color.black);
                            jLogLabel2.setText("Client saved!");
                            if (controller.getSearchResultType().equals("Clients"))
                            {
                                addRowAndRefreshTableInfo(controller.getLastSaved());
                            }
                            ...
                            displayingObjectDetailsType = "Clients";
                            ArrayList<String> temp = controller.getInformationAboutLastAddedClient();
                            jTextField101.setText(temp.get(0));
                            jTextField102.setText(temp.get(1));
                            jTextField103.setText(temp.get(2));
                            jTextField104.setText(temp.get(3));
                        ...
                        {
                            jLogLabel2.setForeground(Color.red);
                            jLogLabel2.setText("Failed to save new client!");
                        }
                    }
                }
                break;
        ...
        } else if (controller.update(jTextField101.getText(), jTextField102.getText(), jTextField103.getText(), jTextField104.getText(), jTextField105.getText(), jTextField106.getText(), jTextField107.getText(), jTextField108.getText(), jTextField109.getText(), jTextField110.getText(), jPasswordShow.getText()))
        {
            jLogLabel2.setForeground(Color.black);
    ...
    {//GEN-HEADEREND:event_jButtonDiscardChangesActionPerformed
        ...
        if (controller.getUserType().equals("Manager") || controller.getUserType().equals("Receptionist"))
        {
            if (controller.currentReservationCreationState())
            {
                if ((controller.getSearchResultType().equals("Rooms") && datesNotChanged)
                        || controller.getSearchResultType().equals("Clients"))
                {
                    jButtonAddToReservation.setEnabled(true);
                } else
                {
        ...
        showDetails(jTextField101.getText());
    ...
    {//GEN-HEADEREND:event_jButtonDeleteActionPerformed
        boolean shouldCloseNewReservationJFrame = false;
        if (controller.getSearchResultType().equals("Reservations") && controller.currentReservationCreationState())
        {
            if (controller.getNewReservationsID().equals(jTextField101.getText()))
            {
                shouldCloseNewReservationJFrame = true;
            }
        }

        if (controller.delete(jTextField101.getText()))
        {
            if (shouldCloseNewReservationJFrame)
            {
                reservationForm.dispose();
            }

            jLogLabel2.setForeground(Color.black);
            jLogLabel2.setText("Entry successfully deleted!");
            for (int i = 0; i < jTable1.getRowCount(); i++)
            {
                if (jTable1.getValueAt(i, 0).toString().equals(jTextField101.getText()))
                {
                    ((CustomTableModel) jTable1.getModel()).removeRow(i);
                    jTable1.setModel(new CustomTableModel(((CustomTableModel) jTable1.getModel()).getData(), ((CustomTableModel) jTable1.getModel()).getColumnNames()));
                    break;
                }
            }
...
//                new CasablancaGUI().setVisible(true);
                CasablancaGUI.getInstance().setVisible(true);
            }
        });
    }
